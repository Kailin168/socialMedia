...
export default function Leftsidebar() {
  ...
  return (
    <div className="w-full">
      <div>
        <div className="shadow-md rounded-lg border border-gray-400 dark:bg-slate-100 dark:text-slate-900">
          <div className="flex items-center justify-center mb-10 mt-5 mr-5 ml-5">
          ...
          <div className="text-3xl font-bold leading-none text-gray-900 dark:text-slate-700 flex justify-center mr-6 mt-5">Profile</div>
          <div className="items-center flex relative text-md font-large mt-7 pl-7">
          ...
          <div className="items-center flex relative text-md font-large mt-7 mb-7 pl-7">
